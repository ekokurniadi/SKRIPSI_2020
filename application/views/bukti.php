...
<section class="section">
  ...
  <div class="row">
      <div class="col-12 col-md-12 col-lg-12">
        ...
        <form action="<?php echo base_url('spp/hasread') ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
	   
              <div class="form-group">
              <label class="col-sm-2 control-label" for="varchar">Foto Bukti Pembayaran <?php echo form_error('nis') ?></label>
                <div class="col-sm-12" style="text-align:left;">
                    <a href ="<?php echo base_url().'image/'.$gambar['foto_spp']?>" target="_blank"><img src="<?php echo base_url().'image/'.$gambar['foto_spp']?>" alt="" width="280px;"></a>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="col-sm-12">
                    <input type="text" class="form-control" value="<?=$gambar['status_spp']?>" readonly>
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-12">
