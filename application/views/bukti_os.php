...
<section class="section">
  <div class="section-header">
    <h1> Bukti Pembayaran Osis </h1>
    <div class="section-header-breadcrumb">
      <div class="breadcrumb-item active"><a href="<?php echo base_url(); ?>dashboard"><i class="fa fa-dashboard"></i> Home</a></div>
      <div class="breadcrumb-item"><a href="#"> Bukti Pembayaran Osis </a></div>
    </div>
  </div>
  ...
  <div class="row">
      <div class="col-12 col-md-12 col-lg-12">
        ...
        <form action="<?php echo base_url('osis/hasread') ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
	   
              <div class="form-group">
              <label class="col-sm-2 control-label" for="varchar">Foto Bukti Pembayaran <?php echo form_error('nis') ?></label>
                <div class="col-sm-12" style="text-align:left;">
                    <a href ="<?php echo base_url().'image/'.$gambar['foto_osis']?>" target="_blank"><img src="<?php echo base_url().'image/'.$gambar['foto_osis']?>" alt="" width="280px;"></a>
                </div>
              </div>
              <div class="form-group">
              <label class="col-sm-2 control-label" for="varchar">Pembayaran Osis Bulan <?php echo form_error('nis') ?></label>
              <div class="col-sm-12">
              ...
              <div class="col-sm-12">
                    <input type="text" class="form-control" value="<?=$gambar['status_osis']?>" readonly>
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-12">
