...
<section class="section">
  ...
  <div class="row">
      <div class="col-12 col-md-12 col-lg-12">
        ...
        <form class="form-horizontal">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="nama_ayah" id="nama_ayah" placeholder="Nama Ayah" value="<?php echo $nama_ayah; ?>" readonly />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="nama_ibu" id="nama_ibu" placeholder="Nama Ibu" value="<?php echo $nama_ibu; ?>" readonly />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="no_telp_orang_tua" id="no_telp_orang_tua" placeholder="No Telp Orang Tua" value="<?php echo $no_telp_orang_tua; ?>" readonly />
                </div>
              </div>
	    ...
	    <a href="<?php echo site_url('siswa') ?>" class="btn btn-icon icon-left btn-success">Cancel</a>
