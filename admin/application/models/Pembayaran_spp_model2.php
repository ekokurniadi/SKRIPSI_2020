...
class Pembayaran_spp_model2 extends CI_Model
{
    ...
    // get all
    function get_all($nis)
    {
        $this->db->query("SELECT * FROM detail_pembayaran where nis='$nis' and status_spp='Belum Lunas'")->result();
    }
