     ...
     <div class="">
       <div class="page-title">
         <div class="title_left">
           <h3>Pembayaran SPP<small></small></h3>
         </div>
       ...
       foreach ($data_spp as $komite)
       {
           ...
           <tr>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('pembayaran/proses_spp/'.$komite->id),'<i class="fa fa-check"></i>Proses Pembayaran',array('title'=>'detail','class'=>'btn btn-danger btn-sm')); 
				?>
			</td>
		</tr>
           <?php
