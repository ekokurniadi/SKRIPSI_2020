       ...
       foreach ($siswa_data as $siswa)
       {
           ...
           <tr>
			...
			<td style="text-align:center" width="200px">
				...
				echo '  '; 
				echo anchor(site_url('siswa/delete/'.$siswa->id),'<i class="fa fa-trash-o"></i>','title="delete" class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Yakin Ingin hapus data ?\')"'); 
				?>
			</td>
		</tr>
           <?php
