...
<body class="login" style="padding-top:100px">
    ...
    <div class="tab-content">
	  ...
	  <form accept-charset="UTF-8" role="form" class="form-signin">
                ...
                <input type="number" placeholder="NIS" class="form-control top" name="nis" id="nis" required>
                <br>
                <input type="date" placeholder="Tanggal lahir" class="form-control bottom" name="tanggal_lahir" id="tanggal_lahir">
                <div class="checkbox">
		  <label>
