     ...
     <div class="">
       <div class="page-title">
         <div class="title_left">
           <h3>Pembayaran Ekstrakurikuler</h3>
         </div>
...
<div class="col-md-12 col-xs-12 col-sm-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Pembayaran Ekstrakurikuler<small></small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form action="<?php echo base_url('pembayaran/proses_bayar_eks') ?>" method="post" class="form-horizontal">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            <label class="col-sm-2 control-label" for="double">Biaya Ekstrakurikuler</label>
            <div class="col-sm-6">
            <input type="text" class="form-control" value="Rp. <?=number_format($data_spp['biaya_ekstrakurikuler'],0,',','.')?>" readonly>
            </div>
         </div>
...
<div class="form-group">
    <input type="hidden" name="id" value="<?php echo $data_spp['id']?>" /> 
	    ...
	    <a href="<?php echo site_url('pembayaran/ekskul') ?>" class="btn bg-orange">Kembali</a>
