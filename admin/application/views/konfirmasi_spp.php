...
<div class="col-md-12 col-xs-12 col-sm-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form action="<?php echo base_url('konfirmasi/proses_spp') ?>" method="post" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
            <a href ="<?php echo $uri.'image/'.$data_spp['foto_spp']?>" target="_blank"><img src="<?php echo $uri.'image/'.$data_spp['foto_spp']?>" alt="" width="280px;"></a>
            </div>
        </div>
