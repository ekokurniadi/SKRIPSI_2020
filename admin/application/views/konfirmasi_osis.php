...
<div class="col-md-12 col-xs-12 col-sm-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Bukti Pembayaran Osis<small></small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form action="<?php echo base_url('konfirmasi/proses_osis') ?>" method="post" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
            <a href ="<?php echo $uri.'image/'.$data_spp['foto_osis']?>" target="_blank"><img src="<?php echo $uri.'image/'.$data_spp['foto_osis']?>" alt="" width="280px;"></a>
            </div>
        </div>
...
<div class="form-group">
    <input type="hidden" name="id" value="<?php echo $data_spp['id']?>" /> 
	    ...
	    <a href="<?php echo base_url('konfirmasi/invalid_osis/'.$data_spp['id']) ?>" class="btn btn-danger">Reject</a>
	    <a href="<?php echo site_url('panel') ?>" class="btn bg-orange">Kembali</a>
