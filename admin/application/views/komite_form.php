...
<div class="col-md-12 col-xs-12 col-sm-12">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="double">Biaya Komite <?php echo form_error('biaya_komite') ?></label>
            <div class="col-sm-6">
                <input type="text" oninput="masking();" class="form-control" name="biaya_komite" id="biaya_komite" placeholder="Biaya Komite" value="<?php echo $biaya_komite; ?>" />
            </div>
    </div>
...
<div class="form-group">
    <input type="hidden" name="id" value="<?php echo $id; ?>" /> 
	    ...
	    <a href="<?php echo site_url('komite') ?>" class="btn btn-default">Cancel</a>
...
var kode_kelasnya = $('#kode_kelas').val(); 
 ...
 $.ajax({      
    method: "POST",      
    url: "<?php echo base_url('komite/ambil_kelas')?>", 
